    ...
    <div class="drawer-content">
      ...
      <nav class="navbar w-full bg-base-100 shadow-sm">
        ...
        <div class="navbar-end">
          ...
          <RouterLink v-if="user.hasPulledUserInfo && !user.isLogin()" :to="{name: 'user-accounts-login-index'}" active-class="btn-active" class="btn btn-neutral btn-outline mr-9 text-base">
            登录
          </RouterLink>
    ...
    <div class="drawer-side is-drawer-close:overflow-visible">
      ...
      <div class="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-16 is-drawer-open:w-54">
        ...
        <ul class="menu w-full grow">
          ...
          <li>
            <RouterLink :to="{name: 'creates-index'}" active-class="menu-focus" class="is-drawer-close:tooltip is-drawer-close:tooltip-right py-3" data-tip="创作">
              <!-- Home icon -->
              <CreateIcon/>
