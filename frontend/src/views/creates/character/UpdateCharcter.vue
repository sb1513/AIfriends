...
import Photo from "@/views/creates/character/components/Photo.vue";
import Name from "@/views/creates/character/components/Name.vue";
import Profile from "@/views/creates/character/components/Profile.vue";
import BackgroundImage from "@/views/creates/character/components/BackgroundImage.vue";
import {onMounted, ref, useTemplateRef} from "vue";
import {base64ToFile} from "@/js/utils/base64_to_file.js";
import api from "@/js/http/api.js";
import {useRoute, useRouter} from "vue-router";
import {useUserStore} from "@/stores/user.js";
import Voice from "@/views/creates/character/components/Voice.vue";
